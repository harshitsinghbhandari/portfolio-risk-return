...
tickers = [
    "AAPL", "MSFT", 
    # "GOOGL", "AMZN", "NVDA", "META", "TSLA", "BRK-B", "JPM", "V",
...
def get_daily_returns_for_multiple_tickers(tickers, start="2024-01-01", end="2025-01-01"):
    ...
    # Convert list of returns to a numpy array for easier manipulation
    returns_list = np.array(returns_list).T  # Transpose to have dates as rows and tickers as columns
    return returns_list
...
if __name__ == "__main__":
    ...
    print(daily_returns_data.shape)  # Display shape of the returns array
